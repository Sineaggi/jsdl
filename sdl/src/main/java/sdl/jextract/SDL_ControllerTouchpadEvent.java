...
public class SDL_ControllerTouchpadEvent {
    ...
    public static float y$get(MemorySegment seg) {
        return (float)constants$151.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float y$get(MemorySegment seg, long index) {
        return (float)constants$151.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float pressure$get(MemorySegment seg) {
        return (float)constants$151.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float pressure$get(MemorySegment seg, long index) {
        return (float)constants$151.const$3.get(seg.asSlice(index*sizeof()));
    }
