...
public class SDL_DollarGestureEvent {
    ...
    public static int type$get(MemorySegment seg) {
        return (int)constants$154.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int type$get(MemorySegment seg, long index) {
        return (int)constants$154.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long touchId$get(MemorySegment seg) {
        return (long)constants$154.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long touchId$get(MemorySegment seg, long index) {
        return (long)constants$154.const$5.get(seg.asSlice(index*sizeof()));
    }
