...
public class SDL_DollarGestureEvent {
    ...
    public static long touchId$get(MemorySegment seg) {
        return (long)constants$158.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long touchId$get(MemorySegment seg, long index) {
        return (long)constants$158.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long gestureId$get(MemorySegment seg) {
        return (long)constants$158.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long gestureId$get(MemorySegment seg, long index) {
        return (long)constants$158.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int numFingers$get(MemorySegment seg) {
        return (int)constants$158.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int numFingers$get(MemorySegment seg, long index) {
        return (int)constants$158.const$2.get(seg.asSlice(index*sizeof()));
    }
