...
public class SDL_JoyAxisEvent {
    ...
    public static byte axis$get(MemorySegment seg) {
        return (byte)constants$136.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte axis$get(MemorySegment seg, long index) {
        return (byte)constants$136.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$136.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$136.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$137.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$137.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$137.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$137.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short value$get(MemorySegment seg) {
        return (short)constants$137.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short value$get(MemorySegment seg, long index) {
        return (short)constants$137.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short padding4$get(MemorySegment seg) {
        return (short)constants$137.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short padding4$get(MemorySegment seg, long index) {
        return (short)constants$137.const$3.get(seg.asSlice(index*sizeof()));
    }
