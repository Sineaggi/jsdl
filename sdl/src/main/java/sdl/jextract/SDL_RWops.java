 ...
 * {@snippet :
 * struct SDL_RWops {
 *     long long (*size)(struct SDL_RWops*);
 *     long long (*seek)(struct SDL_RWops*,long long,int);
 *     unsigned long long (*read)(struct SDL_RWops*,void*,unsigned long long,unsigned long long);
 *     unsigned long long (*write)(struct SDL_RWops*,void*,unsigned long long,unsigned long long);
 ...
 * int (*close)(struct SDL_RWops*);
    ...
    public static final class hidden {
         ...
         * {@snippet :
         * struct {
         *     enum SDL_bool append;
         *     void* h;
         *     struct  buffer;
         * };
         * }
         */
        public static final class windowsio {
        ...
        public static MemorySegment windowsio$slice(MemorySegment seg) {
            return seg.asSlice(0, 40);
        }
        /**
         * {@snippet :
         * struct {
         *     enum SDL_bool autoclose;
         *     struct _iobuf* fp;
         * };
         * }
         */
        ...
        public static MemorySegment stdio$slice(MemorySegment seg) {
