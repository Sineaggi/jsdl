...
public class SDL_UserEvent {
    ...
    public static MemorySegment data1$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$153.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment data1$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$153.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemorySegment data2$get(MemorySegment seg) {
        return (java.lang.foreign.MemorySegment)constants$153.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static MemorySegment data2$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemorySegment)constants$153.const$2.get(seg.asSlice(index*sizeof()));
    }
