...
final class constants$133 {
    ...
    static final VarHandle const$3 = constants$133.const$0.varHandle(MemoryLayout.PathElement.groupElement("which"));
    static final VarHandle const$4 = constants$133.const$0.varHandle(MemoryLayout.PathElement.groupElement("hat"));
    static final VarHandle const$5 = constants$133.const$0.varHandle(MemoryLayout.PathElement.groupElement("value"));
}
