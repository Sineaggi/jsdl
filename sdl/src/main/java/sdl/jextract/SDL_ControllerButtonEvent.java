...
public class SDL_ControllerButtonEvent {
    ...
    public static byte button$get(MemorySegment seg) {
        return (byte)constants$145.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte button$get(MemorySegment seg, long index) {
        return (byte)constants$145.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte state$get(MemorySegment seg) {
        return (byte)constants$145.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte state$get(MemorySegment seg, long index) {
        return (byte)constants$145.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$146.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$146.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$146.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$146.const$1.get(seg.asSlice(index*sizeof()));
    }
