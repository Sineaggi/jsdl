...
public class SDL_ControllerButtonEvent {
    ...
    public static int which$get(MemorySegment seg) {
        return (int)constants$148.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int which$get(MemorySegment seg, long index) {
        return (int)constants$148.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte state$get(MemorySegment seg) {
        return (byte)constants$149.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte state$get(MemorySegment seg, long index) {
        return (byte)constants$149.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$149.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$149.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$149.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$149.const$2.get(seg.asSlice(index*sizeof()));
    }
