...
public class SDL_JoyBallEvent {
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$138.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$138.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short yrel$get(MemorySegment seg) {
        return (short)constants$139.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short yrel$get(MemorySegment seg, long index) {
        return (short)constants$139.const$1.get(seg.asSlice(index*sizeof()));
    }
