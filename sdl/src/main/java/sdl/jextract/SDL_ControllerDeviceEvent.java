...
public class SDL_ControllerDeviceEvent {
    ...
    public static int type$get(MemorySegment seg) {
        return (int)constants$140.const$2.get(seg, 0L);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void type$set(MemorySegment seg, int x) {
        constants$140.const$2.set(seg, 0L, x);
    }
    public static int type$get(MemorySegment seg, long index) {
        return (int)constants$140.const$2.get(seg, index * sizeof());    }
    public static void type$set(MemorySegment seg, long index, int x) {
        constants$140.const$2.set(seg, index * sizeof(), x);
    }
    ...
    public static int timestamp$get(MemorySegment seg) {
        return (int)constants$140.const$3.get(seg, 0L);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void timestamp$set(MemorySegment seg, int x) {
        constants$140.const$3.set(seg, 0L, x);
    }
    public static int timestamp$get(MemorySegment seg, long index) {
        return (int)constants$140.const$3.get(seg, index * sizeof());    }
    public static void timestamp$set(MemorySegment seg, long index, int x) {
        constants$140.const$3.set(seg, index * sizeof(), x);
    }
    ...
    public static int which$get(MemorySegment seg) {
        return (int)constants$140.const$4.get(seg, 0L);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static void which$set(MemorySegment seg, int x) {
        constants$140.const$4.set(seg, 0L, x);
    }
    public static int which$get(MemorySegment seg, long index) {
        return (int)constants$140.const$4.get(seg, index * sizeof());    }
    public static void which$set(MemorySegment seg, long index, int x) {
        constants$140.const$4.set(seg, index * sizeof(), x);
    }
