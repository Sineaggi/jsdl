...
public class SDL_MouseButtonEvent {
    ...
    public static byte state$get(MemorySegment seg) {
        return (byte)constants$136.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte state$get(MemorySegment seg, long index) {
        return (byte)constants$136.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte clicks$get(MemorySegment seg) {
        return (byte)constants$136.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte clicks$get(MemorySegment seg, long index) {
        return (byte)constants$136.const$2.get(seg.asSlice(index*sizeof()));
    }
