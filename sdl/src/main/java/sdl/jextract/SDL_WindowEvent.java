...
public class SDL_WindowEvent {
    ...
    public static byte event$get(MemorySegment seg) {
        return (byte)constants$116.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte event$get(MemorySegment seg, long index) {
        return (byte)constants$116.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$116.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$116.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$116.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$116.const$2.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$116.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$116.const$3.get(seg.asSlice(index*sizeof()));
    }
