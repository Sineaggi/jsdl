...
public class SDL_WindowEvent {
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$128.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$128.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$128.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$128.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$128.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$128.const$5.get(seg.asSlice(index*sizeof()));
    }
