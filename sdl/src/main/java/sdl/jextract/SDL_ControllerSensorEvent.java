...
public class SDL_ControllerSensorEvent {
    ...
    public static int timestamp$get(MemorySegment seg) {
        return (int)constants$152.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int timestamp$get(MemorySegment seg, long index) {
        return (int)constants$152.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int which$get(MemorySegment seg) {
        return (int)constants$152.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int which$get(MemorySegment seg, long index) {
        return (int)constants$152.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static long timestamp_us$get(MemorySegment seg) {
        return (long)constants$152.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static long timestamp_us$get(MemorySegment seg, long index) {
        return (long)constants$152.const$3.get(seg.asSlice(index*sizeof()));
    }
