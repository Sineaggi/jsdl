...
public class SDL_ControllerAxisEvent {
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$144.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$144.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static short padding4$get(MemorySegment seg) {
        return (short)constants$145.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static short padding4$get(MemorySegment seg, long index) {
        return (short)constants$145.const$0.get(seg.asSlice(index*sizeof()));
    }
