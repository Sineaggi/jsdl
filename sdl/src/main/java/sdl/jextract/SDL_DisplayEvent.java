...
public class SDL_DisplayEvent {
    ...
    public static byte event$get(MemorySegment seg) {
        return (byte)constants$114.const$3.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte event$get(MemorySegment seg, long index) {
        return (byte)constants$114.const$3.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$114.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$114.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$114.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$114.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$115.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$115.const$0.get(seg.asSlice(index*sizeof()));
    }
