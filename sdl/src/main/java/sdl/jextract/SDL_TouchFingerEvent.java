...
public class SDL_TouchFingerEvent {
    ...
    public static float y$get(MemorySegment seg) {
        return (float)constants$142.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float y$get(MemorySegment seg, long index) {
        return (float)constants$142.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float dx$get(MemorySegment seg) {
        return (float)constants$142.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float dx$get(MemorySegment seg, long index) {
        return (float)constants$142.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float dy$get(MemorySegment seg) {
        return (float)constants$143.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float dy$get(MemorySegment seg, long index) {
        return (float)constants$143.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static float pressure$get(MemorySegment seg) {
        return (float)constants$143.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static float pressure$get(MemorySegment seg, long index) {
        return (float)constants$143.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static int windowID$get(MemorySegment seg) {
        return (int)constants$143.const$2.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int windowID$get(MemorySegment seg, long index) {
        return (int)constants$143.const$2.get(seg.asSlice(index*sizeof()));
    }
