...
public class SDL_JoyHatEvent {
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$131.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$131.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$131.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$131.const$1.get(seg.asSlice(index*sizeof()));
    }
