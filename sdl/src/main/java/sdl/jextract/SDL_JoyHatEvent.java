...
public class SDL_JoyHatEvent {
    ...
    public static byte hat$get(MemorySegment seg) {
        return (byte)constants$133.const$4.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte hat$get(MemorySegment seg, long index) {
        return (byte)constants$133.const$4.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte value$get(MemorySegment seg) {
        return (byte)constants$133.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte value$get(MemorySegment seg, long index) {
        return (byte)constants$133.const$5.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding1$get(MemorySegment seg) {
        return (byte)constants$134.const$0.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding1$get(MemorySegment seg, long index) {
        return (byte)constants$134.const$0.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding2$get(MemorySegment seg) {
        return (byte)constants$134.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding2$get(MemorySegment seg, long index) {
        return (byte)constants$134.const$1.get(seg.asSlice(index*sizeof()));
    }
