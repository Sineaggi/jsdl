...
final class constants$143 {
    ...
    static final VarHandle const$0 = constants$142.const$4.varHandle(MemoryLayout.PathElement.groupElement("timestamp"));
    static final VarHandle const$1 = constants$142.const$4.varHandle(MemoryLayout.PathElement.groupElement("which"));
    static final VarHandle const$2 = constants$142.const$4.varHandle(MemoryLayout.PathElement.groupElement("level"));
