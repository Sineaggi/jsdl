...
public class SDL_AudioDeviceEvent {
    ...
    public static int which$get(MemorySegment seg) {
        return (int)constants$150.const$1.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static int which$get(MemorySegment seg, long index) {
        return (int)constants$150.const$1.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static byte padding3$get(MemorySegment seg) {
        return (byte)constants$150.const$5.get(seg);
    }
    /**
     * Setter for field:
     * {@snippet :
    ...
    public static byte padding3$get(MemorySegment seg, long index) {
        return (byte)constants$150.const$5.get(seg.asSlice(index*sizeof()));
    }
